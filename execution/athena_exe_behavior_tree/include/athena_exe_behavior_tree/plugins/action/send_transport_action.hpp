...
#ifndef ATHENA_CE_BEHAVIOR_TREE__PLUGINS__ACTION__SEND_TRANSPORT_ACTION_HPP_
#define ATHENA_CE_BEHAVIOR_TREE__PLUGINS__ACTION__SEND_TRANSPORT_ACTION_HPP_
...
class SendTransportAction : public BT::ActionNodeBase
{
public:
  /**
   * @brief A constructor for athena_behavior_tree::SendTransportAction
...
#endif  // ATHENA_CE_BEHAVIOR_TREE__PLUGINS__ACTION__SEND_TRANSPORT_ACTION_HPP_