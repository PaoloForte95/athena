...
def generate_launch_description():
    ...
    params_dir = get_package_share_directory('plan2_planner')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(params_dir, 'params', 'plan2_params.yaml'),
    ...
    load_nodes = GroupAction(
        ...
        Node(
                package='plan2_lifecycle_manager',
