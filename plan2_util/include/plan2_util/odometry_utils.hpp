...
#ifndef PLAN2_UTIL__ODOMETRY_UTILS_HPP_
#define PLAN2_UTIL__ODOMETRY_UTILS_HPP_
...
public:
   ...
   */
  explicit OdomSmoother(
    const plan2_util::LifecycleNode::WeakPtr & parent,
    double filter_duration = 0.3,
    const std::string & odom_topic = "odom");
...
#endif  // PLAN2_UTIL__ODOMETRY_UTILS_HPP_
