...
#ifndef PLAN2_UTIL__SIMPLE_ACTION_SERVER_HPP_
#define PLAN2_UTIL__SIMPLE_ACTION_SERVER_HPP_
...
/**
 * @class plan2_util::SimpleActionServer
...
public:
    ...
    spin_thread_(spin_thread)
  {
    ...
    if (spin_thread_) {
      ...
      executor_thread_ = std::make_unique<plan2_util::NodeThread>(executor_);
    }
  }
...
protected:
  ...
  std::unique_ptr<plan2_util::NodeThread> executor_thread_;
...
#endif   // PLAN2_UTIL__SIMPLE_ACTION_SERVER_HPP_
