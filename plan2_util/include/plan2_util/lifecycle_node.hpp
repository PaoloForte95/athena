...
#ifndef PLAN2_UTIL__LIFECYCLE_NODE_HPP_
#define PLAN2_UTIL__LIFECYCLE_NODE_HPP_
...
namespace plan2_util
{

using CallbackReturn = rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn;

/**
 * @class plan2_util::LifecycleNode
 * @brief A lifecycle node wrapper to enable common Plan2 needs such as manipulating parameters
 */
...
public:
   ...
   */
  std::shared_ptr<plan2_util::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<plan2_util::LifecycleNode>(
   ...
   */
  plan2_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
...
#endif  // PLAN2_UTIL__LIFECYCLE_NODE_HPP_
