...
#ifndef ATHENA_UTIL__SIMPLE_ACTION_SERVER_HPP_
#define ATHENA_UTIL__SIMPLE_ACTION_SERVER_HPP_
...
/**
 * @class athena_util::SimpleActionServer
...
public:
    ...
    spin_thread_(spin_thread)
  {
    ...
    if (spin_thread_) {
      ...
      executor_thread_ = std::make_unique<athena_util::NodeThread>(executor_);
    }
  }
...
protected:
  ...
  std::unique_ptr<athena_util::NodeThread> executor_thread_;
