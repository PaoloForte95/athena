...
#ifndef PLAN2_CORE__PLANNER_HPP_
#define PLAN2_CORE__PLANNER_HPP_
...
public:
   ...
   */
  virtual plan2_msgs::msg::Plan computeExecutionPlan(const std::string & domain, const std::string & problem) = 0;
...
#endif  // PLAN2_CORE__PLANNER_HPP_
