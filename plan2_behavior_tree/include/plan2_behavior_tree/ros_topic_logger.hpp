...
#ifndef PLAN2_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
#define PLAN2_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
...
#include "plan2_msgs/msg/behavior_tree_log.hpp"
#include "plan2_msgs/msg/behavior_tree_status_change.h"
...
public:
  /**
   * @brief A constructor for plan2_behavior_tree::RosTopicLogger
  ...
  : StatusChangeLogger(tree.rootNode())
  {
    ...
    log_pub_ = node->create_publisher<plan2_msgs::msg::BehaviorTreeLog>(
      "behavior_tree_log",
      rclcpp::QoS(10));
  }
  ...
  {
    plan2_msgs::msg::BehaviorTreeStatusChange event;
  ...
  {
    if (!event_log_.empty()) {
      auto log_msg = std::make_unique<plan2_msgs::msg::BehaviorTreeLog>();
...
protected:
  ...
  rclcpp::Publisher<plan2_msgs::msg::BehaviorTreeLog>::SharedPtr log_pub_;
  std::vector<plan2_msgs::msg::BehaviorTreeStatusChange> event_log_;
};

}   // namespace plan2_behavior_tree

#endif   // PLAN2_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
