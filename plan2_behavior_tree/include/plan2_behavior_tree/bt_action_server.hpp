...
#ifndef PLAN2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define PLAN2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
#include "plan2_behavior_tree/behavior_tree_engine.hpp"
#include "plan2_behavior_tree/ros_topic_logger.hpp"
#include "plan2_util/lifecycle_node.hpp"
#include "plan2_util/simple_action_server.hpp"

namespace plan2_behavior_tree
{
/**
 * @class plan2_behavior_tree::BtActionServer
...
{
public:
  using ActionServer = plan2_util::SimpleActionServer<ActionT>;
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      plan2_behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for plan2_behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for plan2_behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
protected:
  ...
  std::unique_ptr<plan2_behavior_tree::BehaviorTreeEngine> bt_;
...
}  // namespace plan22_behavior_tree

#include <plan2_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  // PLAN2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
