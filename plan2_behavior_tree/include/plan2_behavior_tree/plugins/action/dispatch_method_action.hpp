...
#ifndef PLAN2_BEHAVIOR_TREE__PLUGINS__ACTION__DISPATCH_METHOD_ACTION_HPP_
#define PLAN2_BEHAVIOR_TREE__PLUGINS__ACTION__DISPATCH_METHOD_ACTION_HPP_
...
public:
    ...
    typedef std::vector<plan2_msgs::msg::Method> Methods;
    typedef std::vector<plan2_msgs::msg::Action> Actions;
    typedef std::vector<int> IDs;

    /**
     * @brief A constructor for plan2_behavior_tree::DispatchMethodsAction
...
private:
  ...
  plan2_msgs::msg::Method getMethod (int methodID);
