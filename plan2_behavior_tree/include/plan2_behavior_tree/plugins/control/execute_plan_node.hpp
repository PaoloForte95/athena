...
#ifndef PLAN2_BEHAVIOR_TREE__PLUGINS__CONTROL__EXECUTE_PLAN_NODE_HPP_
#define PLAN2_BEHAVIOR_TREE__PLUGINS__CONTROL__EXECUTE_PLAN_NODE_HPP_
...
public:
  /**
   * @brief A constructor for plan2_behavior_tree::ExecutePlanNode
  ...
  /**
   * @brief A destructor for plan2_behavior_tree::ExecutePlanNode
   */
...
#endif  // PLAN2_BEHAVIOR_TREE__PLUGINS__CONTROL__EXECUTE_PLAN_NODE_HPP_
