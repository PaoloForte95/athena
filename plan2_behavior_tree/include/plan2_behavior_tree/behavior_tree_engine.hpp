...
#ifndef PLAN2_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
#define PLAN2_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
...
public:
  /**
   * @brief A constructor for plan2_behavior_tree::BehaviorTreeEngine
   ...
   * @return plan2_behavior_tree::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
...
#endif  // PLAN2_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
