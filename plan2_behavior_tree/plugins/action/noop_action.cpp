...
#include <filesystem>
#include "plan2_behavior_tree/plugins/action/noop_action.hpp"
...
void NoopAction::sendNoop(Actions actions)
  {
    ...
    for(plan2_msgs::msg::Action noop_action: actions){
...
{
  factory.registerNodeType<plan2_behavior_tree::NoopAction>("Noop");
}