...
#include "plan2_behavior_tree/plugins/decorator/selected_robot_controller.hpp"
...
{
  factory.registerNodeType<plan2_behavior_tree::SelectedRobotController>("SelectedRobotController");
}
