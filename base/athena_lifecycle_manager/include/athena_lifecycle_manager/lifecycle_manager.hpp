...
#ifndef ATHENA_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
#define ATHENA_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_HPP_
...
#include "athena_util/lifecycle_service_client.hpp"
#include "athena_util/node_thread.hpp"
#include "rclcpp/rclcpp.hpp"
#include "std_srvs/srv/empty.hpp"
#include "athena_msgs/srv/manage_lifecycle_nodes.hpp"
#include "std_srvs/srv/trigger.hpp"
#include "bondcpp/bond.hpp"
#include "diagnostic_updater/diagnostic_updater.hpp"


namespace athena_lifecycle_manager
{
using namespace std::chrono_literals;  // NOLINT

using athena_msgs::srv::ManageLifecycleNodes;
/**
 * @class athena_lifecycle_manager::LifecycleManager
 * @brief Implements service interface to transition the lifecycle nodes of
 * athena stack. It receives transition request and then uses lifecycle
...
public:
  /**
   * @brief A constructor for athena_lifecycle_manager::LifecycleManager
   * @param options Additional options to control creation of the node.
   */
  explicit LifecycleManager(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for athena_lifecycle_manager::LifecycleManager
   */
  ~LifecycleManager();
...
protected:
  ...
  std::unique_ptr<athena_util::NodeThread> service_thread_;
  ...
  /**
   * @brief function to check if the athena system is active
   */
  ...
  std::map<std::string, std::shared_ptr<athena_util::LifecycleServiceClient>> node_map_;
