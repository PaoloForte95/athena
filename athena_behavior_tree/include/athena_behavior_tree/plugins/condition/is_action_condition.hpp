...
#ifndef ATHENA_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_PLANNER_EQUAL_CONDITION_HPP_
#define ATHENA_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_PLANNER_EQUAL_CONDITION_HPP_
...
public:
  /**
   * @brief A constructor for athena_behavior_tree::IsActionEqualCondition
