...
#ifndef ATHENA_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
#define ATHENA_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
...
public:
  /**
   * @brief A constructor for athena_behavior_tree::RosTopicLogger
