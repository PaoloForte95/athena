...
#ifndef ATHENA_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define ATHENA_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
{
/**
 * @class athena_behavior_tree::BtActionServer
...
{
public:
  using ActionServer = athena_util::SimpleActionServer<ActionT>;
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      athena_behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for athena_behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for athena_behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
protected:
  ...
  std::unique_ptr<athena_behavior_tree::BehaviorTreeEngine> bt_;
...
#include <athena_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  
