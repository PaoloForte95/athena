...
#define ATHENA_BEHAVIOR_TREE__PLUGINS__ACTION__COMPUTE_PLAN_ACTION_HPP_
...
/**
 * @brief A athena_behavior_tree::BtActionNode class that wraps athena_behavior_tree::action::ComputePlan
 */
class ComputePlanAction : public BtActionNode<athena_msgs::action::ComputePlan>
{
public:
  /**
