...
#include "athena_msgs/action/execute_action.hpp"
...
class SendActionAction : public BT::ActionNodeBase
{
public:
  /**
...
protected:
  typedef rclcpp_action::Client<athena_msgs::action::ExecuteAction>::SharedPtr Client;
  using GoalHandleSendLoad = rclcpp_action::ClientGoalHandle<athena_msgs::action::ExecuteAction>;
  void SendAction(athena_msgs::msg::Action action);
...
private:
  ...
  athena_msgs::msg::Action action_;
  ...
  std::map<std::string, Client> clients_;
   ...
   void feedback_callback(GoalHandleSendLoad::SharedPtr, const std::shared_ptr<const athena_msgs::action::ExecuteAction::Feedback> feedback);
