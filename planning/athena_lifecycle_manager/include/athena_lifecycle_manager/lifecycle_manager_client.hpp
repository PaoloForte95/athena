...
#ifndef ATHENA_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_CLIENT_HPP_
#define ATHENA_LIFECYCLE_MANAGER__LIFECYCLE_MANAGER_CLIENT_HPP_
...
public:
  ...
  // Client-side interface to the athena lifecycle manager
  /**
...
protected:
  using ManageLifecycleNodes = athena_msgs::srv::ManageLifecycleNodes;
  ...
  std::shared_ptr<athena_util::ServiceClient<ManageLifecycleNodes>> manager_client_;
  std::shared_ptr<athena_util::ServiceClient<std_srvs::srv::Trigger>> is_active_client_;
