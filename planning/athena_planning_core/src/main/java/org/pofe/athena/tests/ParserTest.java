...
public class ParserTest {
	...
	public static void main(String[] args) throws Exception {
		...
		File domain = new File("src/athena/planning/athena_planning_core/src/main/java/org/pofe/athena/tests/domain.hddl");
		File problem = new File("src/athena/planning/athena_planning_core/src/main/java/org/pofe/athena/tests/pfile01.hddl");
