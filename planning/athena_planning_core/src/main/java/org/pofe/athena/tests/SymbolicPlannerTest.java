...
public class SymbolicPlannerTest {
	...
	public static void main(String[] args) throws Exception {
		...
		File domain = new File("src/athena/planning/athena_planning_core/src/main/java/org/pofe/athena/tests/domain.pddl");
		File problem = new File("src/athena/planning/athena_planning_core/src/main/java/org/pofe/athena/tests/p01.pddl");
