...
#ifndef ATHENA_UTIL__LIFECYCLE_NODE_HPP_
#define ATHENA_UTIL__LIFECYCLE_NODE_HPP_
...
/**
 * @class athena_util::LifecycleNode
 * @brief A lifecycle node wrapper to enable common Athena needs such as manipulating parameters
 */
...
public:
   ...
   */
  std::shared_ptr<athena_util::LifecycleNode> shared_from_this()
  {
    return std::static_pointer_cast<athena_util::LifecycleNode>(
   ...
   */
  athena_util::CallbackReturn on_error(const rclcpp_lifecycle::State & /*state*/)
  {
    RCLCPP_FATAL(
      get_logger(),
