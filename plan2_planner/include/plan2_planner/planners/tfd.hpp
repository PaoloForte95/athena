...
#ifndef PLAN2_PLANNER__PLANNERS__TFD_HPP_
#define PLAN2_PLANNER__PLANNERS__TFD_HPP_
...
{
class TFD : public plan2_core::Planner
{

public:
    /**
     * @brief Construct a new TFD object
     * 
     */
   TFD();
