...
#ifndef PLAN2_PLANNER__PLANNERS__LILOTANE_HPP_
#define PLAN2_PLANNER__PLANNERS__LILOTANE_HPP_
...
{
class Lilotane : public plan2_core::Planner
{

public:
    /**
     * @brief Construct a new Lilotane object
     * 
     */
   Lilotane();
   ...
   /**
    * @brief Destroy the Lilotane object
    * 
    */
  ~Lilotane();
...
protected:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("Lilotane")};
