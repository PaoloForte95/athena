...
int status = system(("java -jar src/athena/plan2_planner/Planners/task_planner.jar metricff " + 
problem_type_ + " " +
domain + " " + 
problem + " " + 
plan_type_+ " " +
...
PLUGINLIB_EXPORT_CLASS(plan2_planner::MetricFF, plan2_core::Planner)