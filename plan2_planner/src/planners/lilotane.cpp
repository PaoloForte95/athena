...
#include "plan2_planner/planners/lilotane.hpp"
...
plan2_msgs::msg::Plan Lilotane::computeExecutionPlan(const std::string & domain, const std::string & problem){
...
int status = system(("java -jar src/athena/plan2_planner/Planners/task_planner.jar lilotane " + 
problem_type_ + " " +
domain + " " + 
problem + " " + 
plan_type_+ " " +
...
PLUGINLIB_EXPORT_CLASS(plan2_planner::Lilotane, plan2_core::Planner)