...
#include "plan2_planner/popf_plan_solver.hpp"
...
plan2_msgs::msg::Plan
POPFPlanSolver::getExecutionPlan(
...
PLUGINLIB_EXPORT_CLASS(plan2_planner::POPFPlanSolver, plan2_core::PlanSolver);
