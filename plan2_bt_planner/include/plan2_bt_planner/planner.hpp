...
#ifndef PLAN2_BT_PLANNER__PLANNER_HPP_
#define PLAN2_BT_PLANNER__PLANNER_HPP_
...
#include "plan2_behavior_tree/bt_action_server.hpp"
...
{
public:
  using Ptr = std::shared_ptr<plan2_bt_planner::Planner<ActionT>>;
  ...
  bool on_configure(
    ...
    plan2_bt_planner::PlannerMuxer * plugin_muxer,
    std::shared_ptr<plan2_util::OdomSmoother> odom_smoother)
  {
    ...
    bt_action_server_ = std::make_unique<plan2_behavior_tree::BtActionServer<ActionT>>(
      node,
      getName(),
      plugin_lib_names,
    ...
    blackboard->set<std::shared_ptr<plan2_util::OdomSmoother>>("odom_smoother", odom_smoother);  // NOLINT
   ...
   */
  std::unique_ptr<plan2_behavior_tree::BtActionServer<ActionT>> & getActionServer()
  {
...
protected:
  ...
  virtual void goalCompleted(
    typename ActionT::Result::SharedPtr result,
    const plan2_behavior_tree::BtStatus final_bt_status) = 0;
  ...
  std::unique_ptr<plan2_behavior_tree::BtActionServer<ActionT>> bt_action_server_;
...
#endif  // PLAN2_BT_PLANNER__PLANNER_HPP_
